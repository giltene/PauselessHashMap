...
/**
 * OriginalHashMap is an implementation of Map. All optional operations (adding and
 * removing) are supported. Keys and values can be any objects.
 */
public class OriginalHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>,
    ...
    /*
     * default size that an OriginalHashMap created using the default constructor would
     * have.
     */
    ...
    /**
     * Constructs a new {@code OriginalHashMap} instance with the specified capacity and
     * load factor.
     *
     * @param capacity
     *            the initial capacity of this hash map.
    ...
    /**
     * Constructs a new {@code OriginalHashMap} instance containing the mappings from
     * the specified map.
     *
     * @param map
     *            the mappings to add.
    ...
    public Object clone() {
        try {
            OriginalHashMap<K, V> map = (OriginalHashMap<K, V>) super.clone();
            map.elementCount = 0;
        ...
        if (keySet == null) {
            keySet = new AbstractSet<K>() {
                ...
                public boolean remove(Object key) {
                    Entry<K, V> entry = OriginalHashMap.this.removeEntry(key);
                    return entry != null;
                }
